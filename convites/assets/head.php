...
<link href="<?php echo $images ?>favicon.png" rel="icon" type="image/x-icon" />
...
<!-- Event snippet for Click LP [VL] conversion page --> <script> gtag('event', 'conversion', {'send_to': 'AW-586022749/MMZ0CK6mxd8BEN3-t5cC'}); </script>
