...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-178601809-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-178601809-1');
</script>

<!-- Global site tag (gtag.js) - Google Ads: 586022749 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-586022749"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-586022749');
</script>
...
<script>
	function pixel() {
		gtag('event', 'conversion', {'send_to': 'AW-586022749/MMZ0CK6mxd8BEN3-t5cC'});
	}
</script>
...
<script type="text/javascript">
	!function(f,b,e,v,n,t,s)
		...
		fbq('init', '626682464701403'); 
		fbq('track', 'PageView');
</script>

<noscript>
	<img height="1" width="1"
	src="https://www.facebook.com/tr?id=626682464701403&ev=PageView
	&noscript=1"/>
</noscript>
